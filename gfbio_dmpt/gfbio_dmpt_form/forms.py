...
# {
#     "email": "sfd@sodfin.de",
#     "message": "pseirn ijnrgp9 er",
#     "dataCollectionAndAssurance": true,
#     "dataCuration": true,
#     "dataArchiving": true,
#     "interestedInFive": true,
#     "dataVisualizationAndAnalysis": true,
#     "dataPublication": true,
#     "interestedInSeven": true
# }

class DmptSupportForm(forms.Form):
    email = forms.EmailField(required=True)
    message = forms.CharField(required=False)
    # TODO: add boolean fields for choices in form
