            ...
            <div>
                <div className="card shadow-sm">
                    <div className="card-body">
                        <h6 className="card-title sidebar-list-item text-center">
                            <i className="mdi mdi-account-voice align-middle icon-green"/>
                            Request DMP Support
                        </h6>
                        <h5>Your request was received</h5>
                        <p>You will soon be contacted by our helpdesk staff.</p>
                        <p>
                            Your issue key is <b>{issue.issue_key}</b>. Please
                            refer to
                            it in any future communication. To access your
                            issue, please
            ...
            <div>
                <div className="card shadow-sm">
                    <div className="card-body">
                        ...
                        <p>
                            Your issue key is <b>{issueKey}</b>. Please refer to
                            it in
                            any future communication. To access your issue,
                            please visit{' '}
                            <a
